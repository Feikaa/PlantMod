...
public class ModItems {
    ...
    public static final Item YELLOW_BERRIES = new AliasedBlockItem(ModBlocks.YELLOW_BERRY_BUSH, new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.1f).statusEffect(new StatusEffectInstance(StatusEffects.POISON, 20*3, 4), 1f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 20*10, 0), 1f).build()));
